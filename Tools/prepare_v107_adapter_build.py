...
# v0.10.2/v0.10.3's modular Art Worker patches advance the launcher marker after v0.9.8.
...
if 'VERSION = "0.10.3"' in text:
    text = text.replace('VERSION = "0.10.3"', 'VERSION = "0.9.8"', 1)
elif 'VERSION = "0.10.2"' in text:
    text = text.replace('VERSION = "0.10.2"', 'VERSION = "0.9.8"', 1)
elif 'VERSION = "0.9.8"' not in text:
    raise SystemExit("expected v0.10.3/v0.10.2/v0.9.8 Bridge launcher marker missing")
