...
# Add the v0.12 conversation/bootstrap entry and installer hardening to the final
# cumulative patch list. The installer-lock stage is also self-bootstrapping so the
# v0.12 runtime marker exists before the inherited Greenline verifier executes.
