...
app = replace_once(app, old_remember, new_remember, "manual memory source boundary")
...
prompt = replace_once(prompt, old_relevant, new_relevant, "focused memory retrieval")
...
prompt = replace_once(prompt, old_profile, new_profile, "focused profile continuity")
...
prompt = replace_once(prompt, old_recent, new_recent, "focused recent context")
...
prompt = replace_once(prompt, old_latest, new_latest, "verbatim newest-message preservation")

PROMPT.write_text(prompt, encoding="utf-8")

print("Applied VexNative v0.11.7.30 natural-continuity patch")
