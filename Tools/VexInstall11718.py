...
def wait_bridge_version(expected:str, seconds:int=30)->None:
...
def main():
    ...
    try:
        ...
        wait_bridge_version(VERSION,seconds=35)
        ...
        messagebox.showinfo('Vex Install',f'Vex {VERSION} installed, SHA256 verified, and both live runtimes verified.\n\nStart a fresh 2-hour support session and enable SAFE maintenance.')
    except Exception as exc:
