...
title_new = '        self.title(f"Vex Windows {VERSION} | wants72")\n'
if "wants72" not in host:
...
if '"vex_wants_field_build": "72"' not in bridge:
...
print("Applied field-visible Vex wants bar + wants72 frozen-build fingerprint")
