...
# The installer is regenerated by the legacy assembler too. Reapply the stable
# desktop restart control here, at the same final field-patch stage, so every
# future v0.12 package recreates one shortcut that follows the current Host.
runpy.run_path("Tools/apply_v120_host_restart_shortcut.py", run_name="__main__")

print("Applied field-visible Vex wants bar + wants74 fingerprint + stable Host restart shortcut")
