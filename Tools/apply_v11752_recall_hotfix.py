...
# Reply-variant state is intentionally restored by the final .52 state hotfix after
# this classifier replacement, because that replacement can remove adjacent globals.
