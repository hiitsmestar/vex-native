...
# The cumulative build already advances the MemoryWorker to 0.11.2.
if 'VERSION = "0.11.2"' not in worker:
    raise SystemExit("v0.11.7.78 expected MemoryWorker v0.11.2 identity missing")
worker = worker.replace('VERSION = "0.11.2"', 'VERSION = "0.11.3"', 1)
...
checks = [
    ...
    ('worker version', 'VERSION = "0.11.3"' in worker),
